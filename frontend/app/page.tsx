    ...
    <div className="bg-white text-stone-900 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute -top-40 -right-40 w-[700px] h-[700px] rounded-full" style={{ background: 'radial-gradient(circle at 60% 40%, rgba(251,146,60,0.08) 0%, transparent 70%)' }} />
        ...
        <div className="relative max-w-5xl mx-auto">
              ...
              <h1 className="text-5xl md:text-7xl font-black leading-[1.05] tracking-tight mb-6 text-stone-900" style={{ fontFamily: "'Archivo Black', sans-serif" }}>
                ...
                <span className="relative inline-block">
                  ...
                  <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 12" fill="none" preserveAspectRatio="none" style={{ height: '8px' }}>
                    <path d="M0 8 Q75 2 150 8 Q225 14 300 8" stroke="#f97316" strokeWidth="2.5" strokeLinecap="round" fill="none" opacity="0.4"/>
                  </svg>
                </span>
          ...
          {/* Floating decoration */}
          <div className="hidden lg:block absolute right-0 top-0 w-[380px]" style={{ animation: 'float 6s ease-in-out infinite' }}>
            <div className="relative">
              {/* Main card */}
              <div className="bg-white rounded-2xl border border-stone-200/80 shadow-[0_8px_40px_rgba(0,0,0,0.08)] p-5">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center">
                    <Logo size={16} className="text-white" />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-stone-800">Wizard IA</div>
                    <div className="text-[10px] text-stone-400">Génération en cours…</div>
                  </div>
                </div>
                <div className="space-y-2">
                  {[
                    { label: 'Authentification', w: '85%', color: 'bg-blue-400' },
                    { label: 'Tableau de bord', w: '60%', color: 'bg-orange-400' },
                    { label: 'API REST', w: '40%', color: 'bg-emerald-400' },
                  ].map(row => (
                    <div key={row.label} className="flex items-center gap-3">
                      <span className="text-[11px] text-stone-500 w-28 shrink-0">{row.label}</span>
              ...
              {/* Mini card 1 */}
              <div className="absolute -top-4 -right-6 bg-white rounded-xl border border-stone-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.07)] p-3 flex items-center gap-2">
                <div className="w-6 h-6 rounded-lg bg-emerald-100 flex items-center justify-center text-emerald-600 text-xs font-bold">✓</div>
                <span className="text-[11px] font-semibold text-stone-700">12 tâches créées</span>
              </div>

              {/* Mini card 2 */}
              <div className="absolute -bottom-4 -left-6 bg-white rounded-xl border border-stone-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.07)] p-3 flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" />
                <span className="text-[11px] font-semibold text-stone-700">IA en ligne</span>
              </div>
            </div>
          </div>
        </div>
            ...
            {FEATURES.map((f, i) => (
              <Reveal key={f.title} delay={i * 60}>
                <div className="bg-white p-7 hover:bg-stone-50 transition-colors duration-200 group h-full">
                  <div className="text-2xl text-stone-300 group-hover:text-orange-400 transition-colors duration-300 mb-5 font-light">{f.icon}</div>
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at 50% 100%, rgba(251,146,60,0.07) 0%, transparent 70%)' }} />
