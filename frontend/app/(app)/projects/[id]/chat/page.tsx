        ...
        <form onSubmit={handleSend} className="relative max-w-4xl mx-auto">
          ...
          <div className="flex gap-2.5">
            ...
            <input id="chat-input" type="text"
              ...
              autoComplete="off"
            />
            <button type="submit" disabled={!newMessage.trim() && !pendingFile} className="w-10 h-10 bg-orange-500 hover:bg-orange-600 disabled:opacity-40 text-white rounded-xl flex items-center justify-center transition-all shadow-lg shadow-orange-500/20 shrink-0 active:scale-90">
