...
export default function ChatPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col h-full bg-stone-50 animate-fadeIn">
      ...
      {/* CHAT INPUT AREA */}
      <div className="fixed lg:relative inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+5.75rem)] lg:bottom-0 z-20 px-4 md:px-8 pb-4 lg:pb-8 pt-3 shrink-0">
        <form onSubmit={handleSend} className="relative max-w-4xl mx-auto">
          ...
          <div className="flex gap-2.5">
            ...
            <input id="chat-input" type="text"
              ...
              autoComplete="off"
            />
            <button type="submit" disabled={!newMessage.trim() && !pendingFile} className="w-10 h-10 bg-orange-500 hover:bg-orange-600 text-white rounded-xl flex items-center justify-center transition-all shadow-lg shadow-orange-500/20 shrink-0 active:scale-90">
