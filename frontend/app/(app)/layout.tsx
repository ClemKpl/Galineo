    ...
    <ToastProvider>
      ...
      <div className="flex h-dvh min-h-0 bg-stone-50 overflow-hidden">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <main className={`min-h-0 flex-1 overflow-x-hidden ${pathname.startsWith('/projects/') || pathname.includes('/ai') || (pathname.includes('/messages') && pathname !== '/messages') || pathname.includes('/chat') ? 'overflow-hidden pb-0' : 'overflow-y-auto pb-24 lg:pb-0'}`}>
            {children}
          </main>
