...
function ProjectCard({ 
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-white rounded-2xl border p-5 transition-all duration-300 cursor-pointer group border-stone-200 hover:border-stone-300 hover:-translate-y-1">
